<div class="setting-item plugins">
    <div class="description">
        ...
        <div class="notes">
            ...
            <div><strong>Note:</strong> <span>Elementor Pro</span> needs to be manually activated with the license key. Some templates will not work if the license key is not provided.</div>
        </div>
